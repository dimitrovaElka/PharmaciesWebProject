...
namespace Pharmacies.Data.Migrations
{
    ...
    [Migration("20181216113650_Update_PharmaciesUser")]
    partial class Update_PharmaciesUser
    {
            ...
            modelBuilder.Entity("Pharmacies.Models.Pharmacy", b =>
                {
                    ...
                    b.Property<string>("MenagerId");

                    b.Property<string>("Name");

                    b.Property<int>("PharmaciesUserId");
            ...
            modelBuilder.Entity("Pharmacies.Models.Pharmacy", b =>
                {
                    ...
                    b.HasOne("Pharmacies.Models.PharmaciesUser", "Menager")
                        .WithMany()
